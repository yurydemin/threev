...
- Сохранение нескольких подключений (профилей), переключение между ними; credentials зашифрованы (AES-256-GCM), опционально — под мастер-паролем
- Файловый менеджер: навигация по бакетам/папкам, поиск, сортировка
- Предпросмотр изображений, PDF и текстовых файлов прямо в приложении
