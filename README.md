...
- Файловый менеджер: навигация по бакетам/папкам, сортировка, клиентский поиск в текущей папке и рекурсивный поиск по всему бакету
...
- Массовые операции: удаление, копирование, перемещение — включая объекты свыше 5 ГБ через серверный multipart-copy
